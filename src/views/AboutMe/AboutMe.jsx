    ...
    <div className="timeline">
      ...
      <div className="container" data-aos="fade-left">
        ...
        <div className="text-box">
          ...
          <ol className="list-disc list-inside">
            <li>
              Beca Banco Interamericano de Desarrollo (BID) - Le Wagon 2023
            </li>
      ...
      <div className="container" data-aos="fade-right">
        ...
        <div className="text-box">
          ...
          <div className="w-full mx-auto flex flex-wrap gap-4 mt-4 bg-black justify-center pt-4">
            ...
            <RiReactjsFill
              size="70"
              className="text-blue-600 animate-moveUpDown"
            />
            <SiMongodb size="60" className="text-green-600" />
            <FaPython
              size="60"
              className="text-yellow-400 animate-moveUpDown"
            />
            ...
            <FaRegFileExcel
              size="60"
              className="text-green-600 animate-moveUpDown"
            />
