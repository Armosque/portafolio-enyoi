...
export const NavBar = () => {
    return (
        <nav className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl font-bold transition-transform transform hover:scale-105 md:text-xl">Full Stack</h1>
            </div>
    ...
    <ul className="text-xl absolute top-[70px]  px-[5%] gap-8 flex justify-between text-center mr-4 content-center justify-items-center  mb-10 clip-circle-0 peer-checked/menu:clip-circle-full transition-[clip-path] duration-500 md:clip-circle-full md:relative md:p-0 md:bg-transparent z-50">
        <Link to="about" className="transition-transform transform hover:scale-110 text-base">Sobre Mí</Link>
        <Link to="projects" className="transition-transform transform hover:scale-110 text-base  ">Proyectos</Link>
        <Link to="contact" className="transition-transform transform hover:scale-110  text-base">Contacto</Link>
    </ul>
        </nav>
    )
}
